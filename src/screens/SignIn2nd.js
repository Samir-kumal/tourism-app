    ...
    return (
      <SafeAreaView className="bg-[#E9EEF2] h-full">
        <View className="h-40 w-full flex justify-center items-center ">
          <Text className="text-black font-semibold text-3xl">Sign In</Text>
        </View>
        ...
        <View className="flex items-center mx-4 h-12 justify-center ">
          <Text>
            Or continue with
          </Text>
        </View>
        ...
        <View className="flex items-center mx-4 h-16 justify-center ">
        <Text>
